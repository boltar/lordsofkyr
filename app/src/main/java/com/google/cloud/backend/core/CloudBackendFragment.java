...
import com.boltarstudios.lok.GCMIntentService;
    ...
    public void signInAndSubscribe(boolean overrideCurrent) {
        ...
        if (Consts.IS_AUTH_ENABLED) {
            ...
            if (accountName == null || overrideCurrent) {
                ...
                Log.d(Consts.TAG, "subscribing to broadcast... ??");
        ...
        CloudCallbackHandler<List<CloudEntity>> handler =
                new CloudCallbackHandler<List<CloudEntity>>() {
                    ...
                    public void onComplete(List<CloudEntity> results) {
                    	Log.d(Consts.TAG, "onComplete from subscribing to broadcast");
